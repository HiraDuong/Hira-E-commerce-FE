...
export const Footer = () => {
    return (
        <footer className="bg-black text-white grid grid-cols-5 gap-4 p-5 [&_p]:text-wrap">
            <div className="col-span-1 flex flex-col">
                <p className="text-2xl font-bold">Hira E-Commerce</p>
                <p>Subscribe</p>
                <p>Get 10% off your first order</p>
                <form className="mt-4 w-48">
                    <div className="">
                        <div className="relative w-full min-w-20 h-10">
            ...
            <div className="col-span-1 flex flex-col">
                ...
                <span className="flex flex-row h-24 mt-4">
                    ...
                    <div className="flex justify-around flex-col ml-4">
                        <Link to="">
                            <img className="h-10" src="./GetItOnGooglePlay.png" alt="ch-play" />
                        </Link>
                        <Link to="">
                            <img className="h-10" src="./DownloadOnAppStore.png" alt="app-store" />
                        </Link>
                    </div>
                </span>
            </div>
            <div className="col-span-5 text-gray-500 border-gray-500 text-center pt-8 pb-8 border-solid border-2">
                &copy; 2022 Hira E-Commerce. All rights reserved.
            </div>
        </footer>
    );
}
